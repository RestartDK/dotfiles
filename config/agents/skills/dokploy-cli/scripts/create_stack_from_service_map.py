...
Usage:
  ...
  export DOKPLOY_API_KEY="..."  # DOKPLOY_AUTH_TOKEN is also accepted
...
def main() -> int:
    ...
    dokploy_auth_token = os.environ.get("DOKPLOY_API_KEY") or os.environ.get("DOKPLOY_AUTH_TOKEN")
    if not dokploy_url or not dokploy_auth_token:
        raise SystemExit("DOKPLOY_URL and DOKPLOY_API_KEY (or DOKPLOY_AUTH_TOKEN) must be set")
