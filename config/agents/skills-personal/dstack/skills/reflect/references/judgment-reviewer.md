...
- `Read` tool calls against any `SKILL.md` file (workspace `.agents/skills/`, user-level `~/.agents/skills/`, or plugin-installed paths under `~/.agents/skills/`)
- subagent task prompts that name a skill path
