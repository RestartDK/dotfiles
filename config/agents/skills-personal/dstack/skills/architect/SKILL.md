...
Use your configured architect runners (defaults `anthropic/claude-fable-5-1:xhigh`, `gpt-5.6-sol`, `openrouter/z-ai/glm-5.3-flash:xhigh`, `anthropic/claude-opus-5:xhigh`).
