...
dstack wiring: an application of the **technical-writing** primitive and **principle-concise**; the ship path runs through `dstack-mode/playbooks/opening-a-pr.md`.
