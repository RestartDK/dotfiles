...
`models.md`. Defaults: mechanical code → openrouter/z-ai/glm-5.3-flash:xhigh, precise-spec code → gpt-5.6-sol, judgment/prose/review → anthropic/claude-fable-5:xhigh.
