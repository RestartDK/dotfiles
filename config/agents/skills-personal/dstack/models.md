...
Model routes live outside shared skills at `${XDG_CONFIG_HOME:-$HOME/.config}/dstack/models.json`. Nix selects `config/agents/model-profiles/work.json` or `personal.json` through `my.ai.profile`.
