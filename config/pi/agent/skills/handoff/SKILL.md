...
If the user passed arguments after `/skill:handoff`, treat those arguments as the description of what the next session will focus on and tailor the handoff document accordingly.
