...
import { isSleepPolling, LIMIT_SECONDS } from "./classify.ts";
...
const REASON =
  ...
  `\`watch\` for readiness patterns; \`wait_agent\` for agent panes. Sleeps under ${LIMIT_SECONDS}s outside loops are allowed.`;
